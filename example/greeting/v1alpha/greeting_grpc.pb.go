...
const (
	GreetingService_SayHello_FullMethodName = "/example.greeting.v1alpha.GreetingService/SayHello"
)
...
var GreetingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "example.greeting.v1alpha.GreetingService",
	...
	Metadata: "greeting/v1alpha/greeting.proto",
}
